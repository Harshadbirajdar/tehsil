        ...
        <div className="container-fluid ps-md-0">
            <div className="row g-0">
              ...
              <div className="login d-flex align-items-center p-t-24 width-100 flex-direction-column">
                <div>
                  <p className="color-white fs-40 font-weight-600"><span><img className="m-r-18" src="Seal_of_Maharashtra.png" height="100" width="100"/></span>सोलापूर तहसीलदार कार्यालय</p>
                </div>
                    ...
                    <div className="row">
                      <div className="col-md-9 col-lg-8 mx-auto">
                        ...
                        <form>
                          ...
                          <div className="d-grid">
                          <a className="btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-2 fs-22" type="button"><span><svg className="m-r-10" xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M20.55 32.75 18.4 30.6 23.5 25.5H6V22.5H23.4L18.3 17.4L20.45 15.25L29.25 24.05ZM24.45 42V39H39Q39 39 39 39Q39 39 39 39V9Q39 9 39 9Q39 9 39 9H24.45V6H39Q40.2 6 41.1 6.9Q42 7.8 42 9V39Q42 40.2 41.1 41.1Q40.2 42 39 42Z" fill="#ffffff"/></svg></span>लॉगिन कर</a>
                            <div className="text-center">
                              <a className="small" href="#">पासवर्ड विसरला ?</a>
                            </div>
                          </div>
                        </form>
                      </div>
